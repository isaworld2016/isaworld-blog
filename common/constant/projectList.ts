...
export const projectList: ProjectList[] = [
  {
    title: "Alliex 베트남 결제중계 시스템 구축 - 외부(상주)",
  ...
  },
  {
    ...
    mainJob: [
      "고도화 작업: 여러 명에 의해 다른 스타일로 작성되어있던 레거시 소스에 코드 컨벤션을 정의하고 전체 코드에 적용하였습니다.",
      "유료 라이브러리에 종속되어있던 컴포넌트를 자체 개발하였습니다.(테이블)",
      "PG 백오피스에서 주로 사용될 업무 메뉴들을 기획/설계하고 개발하였습니다.",
      "Hibernate(JPA)로 서버 코드를 기술하고 CI/CD(Jenkins)로 자동 통합/배포 하였습니다.",
    ]
  },
  {
    title: "CJ PAY 간편결제 시스템구축 - 외부(상주)",
    ...
    mainJob: [
      ...
      "Excel로 작업해오던 화면 설계서를 카카오 Oven으로 작업할 것을 제안하여 개발자 간의 업무 효율을 높혔습니다.",
